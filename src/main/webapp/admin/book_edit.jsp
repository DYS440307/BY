...
<div class="container-fluid">
    ...
    <form class="form-horizontal" action="book_update.action" method="post" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-6">
                <input type="text" class="form-control" id="input_name" name="bname" value="${g.bname}"
                       required="required">
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-sm-6">
                <input type="text" class="form-control" id="input_name" name="bisbn" value="${g.bisbn}"
                       required="required">
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-sm-6">
                <input type="text" class="form-control" id="input_name" name="bauthor" value="${g.bauthor}"
                       required="required">
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-sm-6">
                <input type="text" class="form-control" id="input_name" name="bpublisher" value="${g.bpublisher}"
                       required="required">
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-sm-6">
                <select class="form-control" id="select_topic" name="btid">
                    ...
                    <c:forEach items="${bookTypes }" var="t">
                        <option
                                <c:if test="${t.btid==g.btid }">selected="selected"</c:if>
                                value="${t.btid }">${t.btname }</option>
                    </c:forEach>
