...
<div class="container-fluid">
    ...
    <ul role="tablist" class="nav nav-tabs">
        <li
                ...
                href="order_list.action?pageNumber=1&ostatus=1">全部订单</a></li>
        <li
                <c:if test="${ostatus==5 }">class="active"</c:if> role="presentation"><a
                href="order_list.action?pageNumber=1&ostatus=5">未付款</a></li>
        <li
                <c:if test="${ostatus==2 }">class="active"</c:if> role="presentation"><a
                href="order_list.action?pageNumber=1&ostatus=2">已付款</a></li>
        <li
                <c:if test="${ostatus==3 }">class="active"</c:if> role="presentation"><a
                href="order_list.action?pageNumber=1&ostatus=3">配送中</a></li>
        <li
                <c:if test="${ostatus==4 }">class="active"</c:if> role="presentation"><a
                href="order_list.action?pageNumber=1&ostatus=4">已完成</a></li>
    </ul>
