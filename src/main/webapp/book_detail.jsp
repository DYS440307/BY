                ...
                <div class="flexslider">
                    ...
                    <ul class="slides">
                        <li data-thumb="${book.bcover}">
                            <div class="thumb-image"><img src="${book.bcover}" data-imagezoom="true"
                                                          class="img-responsive"></div>
                        </li>
                        <li data-thumb="${book.bimage1}">
                            <div class="thumb-image"><img src="${book.bimage1}" data-imagezoom="true"
                                                          class="img-responsive"></div>
                        </li>
                        <li data-thumb="${book.bimage2}">
                            <div class="thumb-image"><img src="${book.bimage2}" data-imagezoom="true"
                                                          class="img-responsive"></div>
                        </li>
                    </ul>
                </div>
